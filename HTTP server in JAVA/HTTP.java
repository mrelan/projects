...
";
  ...
  public void run() {
    try {
      ...
      if (meth.equals("GET") || meth.equals("POST")) {
        ...
        if (ext.equals(".html") || ext.equals(".htm")) {
          ...
          if (filexists) {
            ...
            contenttypeline = "Content-Type: text/html" + CRLF;
            entitybody = "<HTML>" + "<HEAD><TITLE>404 Not Found</TITLE></HEAD>" + "<BODY><H1>404 File Not Found</H1></BODY></HTML>";
          }
          ...
          entitybody =
            ...
            "<BODY><H1>400 A malformed HTTP request is reived</H1></BODY></HTML>";
        }
      } else {
        statusline = "HTTP/1.0 400 Not Found" + CRLF;
        contenttypeline = "Content-Type: text/html" + CRLF;
      ...
      while (!done) {
        headerline = in.readLine();
        if (headerline == null) done = true; else {
          System.out.println(headerline);
        }
      }
