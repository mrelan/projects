...
path <- "G:/Shared drives/2020 FIRE-APHIS/DATA/NPIP/NPIP-MD.xlsx"
...
final <- read_excel("G:/Shared drives/2020 FIRE-APHIS/OUTPUT/NPIP/NPIP-MD/final.xlsx")

write.csv(final, file = "G:/Shared drives/2020 FIRE-APHIS/INTERMEDIATE/cleaned_npip_md.csv")
