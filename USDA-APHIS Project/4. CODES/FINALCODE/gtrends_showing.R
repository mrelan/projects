...
map<-tm_shape(metro)+tm_borders("gray20", alpha=0.2)+
  ...
  tm_layout(title = "flea market",legend.text.size=0.7, legend.title.size=1)

tmap_save(map,
          filename="G:/Shared drives/2020 FIRE-APHIS/INTERMEDIATE/trends_showing.png",
          dpi=500, )
################################################################
words<-c("\"poultry show\"", 
         "\"poultry swap meet\"", 
...
write.csv(allwords, "gtrends_showing.csv")  
